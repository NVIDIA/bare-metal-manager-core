...
- [MR-4600](https://gitlab-master.nvidia.com/nvmetal/carbide/-/merge_requests/4600): Moved ipmitool handling to earlier in the bfb install to rule out partial firmware updates causing ipmitool to hang
