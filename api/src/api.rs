...
impl Forge for Api {
    ...
    async fn list_hosts_waiting_for_reprovisioning(
        ...
        let mut txn = self
            ...
            .begin()
            .await
            .map_err(|e| DatabaseError::txn_begin("list_hosts_waiting_for_reprovisioning ", e))
            .map_err(CarbideError::from)?;
    ...
    async fn find_connected_devices_by_dpu_machine_ids(
        ...
        let mut txn = self
            ...
            .begin()
            .await
            .map_err(|e| DatabaseError::txn_begin("find_connected_devices_by_dpu_machine_ids", e))
            .map_err(CarbideError::from)?;
    ...
    async fn find_network_devices_by_device_ids(
        ...
        let mut txn = self.database_connection.begin().await.map_err(|e| {
            CarbideError::from(DatabaseError::txn_begin(
