...
impl From<utils::ManagedHostOutput> for ManagedHostRowDisplay {
    fn from(o: utils::ManagedHostOutput) -> Self {
        ...
        ManagedHostRowDisplay {
            ...
            host_bmc_ip: o.host_bmc_ip.unwrap_or(UNKNOWN.to_string()),
            dpu_bmc_ip: o.dpu_bmc_ip.unwrap_or(UNKNOWN.to_string()),
            host_admin_ip: o.host_admin_ip.unwrap_or(UNKNOWN.to_string()),
            host_admin_mac: o.host_admin_mac.unwrap_or(UNKNOWN.to_string()),
...
impl From<utils::ManagedHostOutput> for ManagedHostDetail {
    fn from(m: utils::ManagedHostOutput) -> Self {
        ...
        Self {
            ...
            host_bmc_ip: m.host_bmc_ip.unwrap_or(UNKNOWN.to_string()),
            host_bmc_mac: m.host_bmc_mac.unwrap_or(UNKNOWN.to_string()),
            ...
            host_admin_ip: m.host_admin_ip.unwrap_or(UNKNOWN.to_string()),
            host_admin_mac: m.host_admin_mac.unwrap_or(UNKNOWN.to_string()),
            ...
            dpu_bmc_ip: m.dpu_bmc_ip.unwrap_or(UNKNOWN.to_string()),
            dpu_bmc_mac: m.dpu_bmc_mac.unwrap_or(UNKNOWN.to_string()),
            ...
            dpu_oob_ip: m.dpu_oob_ip.unwrap_or(UNKNOWN.to_string()),
            dpu_oob_mac: m.dpu_oob_mac.unwrap_or(UNKNOWN.to_string()),
