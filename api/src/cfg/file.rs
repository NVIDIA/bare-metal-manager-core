            ...
            dpu_models: HashMap::from([("bluefield2".to_string(), Firmware {
                ...
                components: HashMap::from([(FirmwareComponentType::Bmc, FirmwareComponent {
                    ...
                    known_firmware: vec![FirmwareEntry {
                        ...
                        default: true,
                        filename: Some("/forge-boot-artifacts/blobs/internal/firmware/nvidia/dpu/bf2-bmc-ota-23.10-5-OPN.tar".to_string()),
                        url: None,
                        checksum: None,
                ...
                components: HashMap::from([(FirmwareComponentType::Bmc, FirmwareComponent {
                    ...
                    (FirmwareComponentType::Cec, FirmwareComponent {
                        ...
                        preingest_upgrade_when_below: None,
                        known_firmware: vec![FirmwareEntry {
                            version: "00.02.0152.0000_n02".to_string(),
                            mandatory_upgrade_from_priority: None,
                            default: true,
                            filename: Some("/forge-boot-artifacts/blobs/internal/firmware/nvidia/dpu/cec1736-ecfw-00.02.0152.0000-n02-rel-prod.fwpkg".to_string()),
                            url: None,
                            checksum: None,
                            install_only_specified: false,
                            power_drains_needed: None,
