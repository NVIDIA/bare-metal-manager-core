...
pub mod tests {
    ...
    use crate::tests::db::attestation as db_attest;
    use carbide::attestation::get_ek_cert_by_machine_id;
    use carbide::attestation::tpm_ca_cert::match_update_existing_ek_cert_status_against_ca;
    use carbide::db::attestation::EkCertVerificationStatus;
    ...
    use carbide::attestation::extract_ca_fields;
    ...
    use carbide::attestation::match_insert_new_ek_cert_status_against_ca;
