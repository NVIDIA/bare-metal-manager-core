...
async fn test_instance_uses_custom_ipxe_only_once(pool: sqlx::PgPool) {
    ...
    let host_arch = forge::MachineArchitecture::X86;
    ...
    env.run_machine_state_controller_iteration_until_state_condition(&mh.id, 5, |machine| {
        matches!(
            ...
            nico_api_model::machine::ManagedHostState::Assigned {
    ...
    env.api
        .invoke_instance_power(tonic::Request::new(forge::InstancePowerRequest {
            ...
            operation: forge::instance_power_request::Operation::PowerReset as _,
...
pub async fn create_instance<'a, 'b>(
    ...
    let mut os: forge::OperatingSystem = default_os_config();
