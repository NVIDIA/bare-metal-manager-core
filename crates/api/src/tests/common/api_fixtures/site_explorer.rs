...
pub struct TestRackDbBuilder {
    ...
    rack_id: RackId,
    rack_type_definition: Option<model::rack_type::RackTypeDefinition>,
}
...
impl TestRackDbBuilder {
    ...
    pub fn with_rack_type_definition(
        mut self,
        rack_type_def: model::rack_type::RackTypeDefinition,
    ) -> Self {
        self.rack_type_definition = Some(rack_type_def);
        self
    }
    ...
    pub async fn persist(&self, txn: &mut PgConnection) -> Result<RackId, DatabaseError> {
        ...
        let cfg = RackConfig {
            ...
            rack_type_definition: self.rack_type_definition.clone(),
        };
