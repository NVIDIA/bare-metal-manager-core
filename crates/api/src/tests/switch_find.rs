...
async fn test_find_switch_ids_and_by_ids(
    ...
    let switch_ids = env
        .api
        .find_switch_ids(tonic::Request::new(forge::SwitchSearchFilter {
            ..Default::default()
        }))
        .await?
        .into_inner()
    ...
    let switches = env
        .api
        .find_switches_by_ids(tonic::Request::new(forge::SwitchesByIdsRequest {
...
async fn test_find_switch_ids_excludes_deleted(
    ...
    // Delete switch2
    env.api
        .delete_switch(tonic::Request::new(forge::SwitchDeletionRequest {
            id: Some(switch_id2),
        }))
        .await?;
