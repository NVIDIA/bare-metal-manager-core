...
//! Deferred database write operations for the rack state handler.
...
/// Persists a snapshot of a rack's aggregate health into `rack_health_history`.
///
...
pub struct PersistRackHealthHistory {
    pub rack_id: RackId,
    pub health_report: HealthReport,
}

#[async_trait]
impl WriteOp for PersistRackHealthHistory {
