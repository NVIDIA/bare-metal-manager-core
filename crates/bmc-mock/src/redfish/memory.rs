...
pub fn system_resource<'a>(system_id: &str, memory_id: &'a str) -> redfish::Resource<'a> {
...
pub fn metrics_resource(system_id: &str, memory_id: &str) -> redfish::Resource<'static> {
...
pub fn hbm(system_id: &str, memory_id: &str, capacity_mib: u64) -> Memory {
