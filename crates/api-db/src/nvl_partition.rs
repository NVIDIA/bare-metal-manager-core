...
use nico_api_model::nvl_partition::{NewNvlPartition, NvlPartition, NvlPartitionSnapshotPgJson};
...
pub async fn find_ids(
    txn: impl DbReader<'_>,
    filter: nico_api_model::nvl_partition::NvLinkPartitionSearchFilter,
