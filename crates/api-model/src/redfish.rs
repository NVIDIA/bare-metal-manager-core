...
impl From<forge::RedfishActionId> for RedfishActionId {
    fn from(id: forge::RedfishActionId) -> Self {
        RedfishActionId {
...
impl From<forge::RedfishListActionsRequest> for RedfishListActionsFilter {
    fn from(req: forge::RedfishListActionsRequest) -> Self {
...
impl From<forge::RedfishCreateActionRequest> for RedfishCreateAction {
    fn from(req: forge::RedfishCreateActionRequest) -> Self {
        RedfishCreateAction {
            target: req.target,
            action: req.action,
...
impl From<ActionRequest> for forge::RedfishAction {
    fn from(value: ActionRequest) -> Self {
        Self {
            ...
            results: value
                .results
                .into_iter()
                .map(|r| forge::OptionalRedfishActionResult {
                    result: r.map(|r| forge::RedfishActionResult {
                        headers: r.headers,
                        status: r.status,
                        body: r.body,
...
mod tests {
    ...
    fn redfish_action_id_from_rpc() {
        let rpc_id = forge::RedfishActionId { request_id: 42 };
    ...
    fn redfish_list_actions_filter_from_rpc() {
        let rpc_req = forge::RedfishListActionsRequest {
    ...
    fn redfish_create_action_from_rpc() {
        let rpc_req = forge::RedfishCreateActionRequest {
