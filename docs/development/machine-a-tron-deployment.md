...
- Access to `nvcr.io/0837451325059433/carbide-dev` (NVIDIA Container Registry)
...
- The image pull secret `nvcr-carbide-dev` in the `nico-mat` namespace
...
kubectl create secret docker-registry nvcr-carbide-dev \
  -n nico-mat \
