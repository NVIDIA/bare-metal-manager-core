...
NICo allocates and configures IP address pools (BGP, loopback, host OS), DHCP, and DNS as part of the ingestion workflow.
...
1. TPM reset
1. Re-attestation via Measured Boot and TPM verification
1. Firmware integrity re-validation
