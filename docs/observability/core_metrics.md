...
<tr><td>carbide_object_state_sla_seconds</td><td>gauge</td><td>Resolved SLA in seconds for an object's current state. Exposed only on the opt-in per-object endpoint.</td></tr>
