...
// APIDpuNetworkConfig represents the network configuration fields exposed for a DPU.
...
type APIDpuMachine struct {
	...
	// DpuNetworkConfig contains the network configuration fields exposed for the DPU.
