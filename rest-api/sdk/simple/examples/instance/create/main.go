...
func main() {
	...
	instanceCreateRequest := simple.InstanceCreateRequest{
		...
		IpxeScript: "chain ${base-url}/internal/x86_64/qcow-imager.efi loglevel=7 console=ttyS0,115200 console=tty0 console=ttyS1,115200 pci=realloc=off image_distro_name=ubuntu image_distro_version=22.04 ds=nocloud;s=${tenant-cloudinit-url}\nboot",
		UserData:   &userData,
		SSHKeys: []string{
