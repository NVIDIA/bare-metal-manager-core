...
type BatchInstanceCreateRequest struct {
	...
	// External power provisioning profile to apply to every Instance in the batch. A non-empty value requires the Site's `powerProvisioning` mode to be `external` or `dps`.
