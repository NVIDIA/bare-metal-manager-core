...
type VpcCreateRequest struct {
	...
	// External power provisioning resource group to associate with the VPC. A non-empty value requires the Site's `powerProvisioning` mode to be `external` or `dps`.
