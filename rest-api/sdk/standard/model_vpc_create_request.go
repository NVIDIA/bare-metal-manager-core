...
type VpcCreateRequest struct {
	...
	// Specify a Site-configured routing profile returned by GET `/tenant/current/routing-profiles` for the VPC. Only supported when `networkVirtualizationType` is set to `FNN`, or when `networkVirtualizationType` is omitted and Site has Native Networking enabled. Requires Tenant to have elevated privilege.
