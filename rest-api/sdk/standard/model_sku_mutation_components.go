...
type SkuMutationComponents struct {
	...
	// Storage components
	Storage []SkuStorageMutation `json:"storage,omitempty"`
	// Chassis component
...
func (o *SkuMutationComponents) GetStorage() []SkuStorageMutation {
	if o == nil || IsNil(o.Storage) {
		var ret []SkuStorageMutation
		return ret
	}
	return o.Storage
}
...
// and a boolean to check if the value has been set.
func (o *SkuMutationComponents) GetStorageOk() ([]SkuStorageMutation, bool) {
	if o == nil || IsNil(o.Storage) {
		return nil, false
	}
...
// SetStorage gets a reference to the given []SkuStorageMutation and assigns it to the Storage field.
func (o *SkuMutationComponents) SetStorage(v []SkuStorageMutation) {
	o.Storage = v
}
