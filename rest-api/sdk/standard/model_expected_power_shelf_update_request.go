...
type ExpectedPowerShelfUpdateRequest struct {
	...
	// Immutable MAC address of the Expected Power Shelf's BMC (Baseboard Management Controller). Omit this field when updating. A formatting-equivalent value is accepted for compatibility, but changing the physical MAC address is rejected.
	// Deprecated
