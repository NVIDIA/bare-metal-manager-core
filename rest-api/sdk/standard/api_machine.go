...
type ApiDeleteDecommissionedManagedHostRequest struct {
	ctx        context.Context
	ApiService *MachineAPIService
	org        string
	machineId  string
...
func (r ApiDeleteDecommissionedManagedHostRequest) Execute() (*http.Response, error) {
	return r.ApiService.DeleteDecommissionedManagedHostExecute(r)
}

/*
DeleteDecommissionedManagedHost Delete a decommissioned managed host

Permanently remove a managed host after Core has reached its terminal
`Decommissioned` state. This also removes the managed host's attached
DPUs, credentials, and Site Explorer and DHCP suppression entries.
...
`PROVIDER_ADMIN` suffix.
	...
	@param org Name of the Org
	@param machineId ID of the managed host Machine
	@return ApiDeleteDecommissionedManagedHostRequest
*/
func (a *MachineAPIService) DeleteDecommissionedManagedHost(ctx context.Context, org string, machineId string) ApiDeleteDecommissionedManagedHostRequest {
	return ApiDeleteDecommissionedManagedHostRequest{
		ApiService: a,
		ctx:        ctx,
		org:        org,
...
// Execute executes the request
func (a *MachineAPIService) DeleteDecommissionedManagedHostExecute(r ApiDeleteDecommissionedManagedHostRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MachineAPIService.DeleteDecommissionedManagedHost")
	if err != nil {
