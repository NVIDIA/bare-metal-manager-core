...
mod legacy_rpc {
    ...
    impl From<super::MachineId> for MachineId {
        fn from(value: crate::uuid::machine::MachineId) -> Self {
            Self {
                id: value.to_string(),
            }
        }
...
pub struct RpcMachineTypeWrapper(crate::forge::MachineType);

impl From<MachineType> for RpcMachineTypeWrapper {
    fn from(value: MachineType) -> Self {
        RpcMachineTypeWrapper(match value {
            MachineType::PredictedHost | MachineType::Host => crate::forge::MachineType::Host,
            MachineType::Dpu => crate::forge::MachineType::Dpu,
        })
    }
}

impl Deref for RpcMachineTypeWrapper {
    type Target = crate::forge::MachineType;
