...
impl From<IBPartitionId> for crate::common::Uuid {
...
impl TryFrom<crate::common::Uuid> for IBPartitionId {
...
impl TryFrom<Option<crate::common::Uuid>> for IBPartitionId {
    ...
    fn try_from(msg: Option<crate::common::Uuid>) -> Result<Self, Box<dyn std::error::Error>> {
        let Some(input_uuid) = msg else {
            ...
            return Err(eyre::eyre!("missing id_partition_id argument").into());
        };
