...
3. Try to identify the state transitions for your subnet and machine on the [Forge dashboard](https://ngcobservability-grafana.thanos.nvidiangn.net/d/WzX_VErVk/argo-forge-sites?orgId=1&var-ClusterName=dev03). For access to metrics, please refer to [Thanos access](observability/site_metrics.md#thanos-access). Please don’t edit/modify the dashboard at this point in time. If Grafana asks you whether to save anything press cancel.
