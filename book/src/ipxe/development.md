...
1. Install 'mkosi' and 'debootstrap' from repository -- for Debian it was ```sudo apt install mkosi debootstrap```
2. Build IPXE image -- ```cd $CARBIDE_ROOT_DIR/pxe && cargo make create-ephemeral-image && cargo make ipxe-x64_64```
