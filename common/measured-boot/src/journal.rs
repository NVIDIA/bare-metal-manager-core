...
#[cfg(feature = "cli")]
use {
    utils::admin_cli::ToTable,
    utils::admin_cli::{just_print_summary, serde_just_print_summary},
};
...
impl MeasurementJournal {
    ...
    ////////////////////////////////////////////////////////////
    pub fn from_grpc(some_pb: Option<&MeasurementJournalPb>) -> crate::Result<Self> {
        some_pb
