...
use crate::records::{MeasurementBundleState, MeasurementBundleValueRecord};
...
impl MeasurementBundle {
    ...
    ////////////////////////////////////////////////////////////
    pub fn from_grpc(some_pb: Option<&MeasurementBundlePb>) -> crate::Result<Self> {
        some_pb
            .ok_or(crate::Error::RpcConversion(String::from(
...
impl TryFrom<MeasurementBundlePb> for MeasurementBundle {
    ...
    fn try_from(msg: MeasurementBundlePb) -> Result<Self, Box<dyn std::error::Error>> {
        let state = msg.state();
        let values: crate::Result<Vec<MeasurementBundleValueRecord>> = msg
            .values
            .iter()
            .map(
