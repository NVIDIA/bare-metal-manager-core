...
use crate::records::MeasurementSystemProfileAttrRecord;
...
impl MeasurementSystemProfile {
    ...
    ////////////////////////////////////////////////////////////
    pub fn from_grpc(some_pb: Option<&MeasurementSystemProfilePb>) -> crate::Result<Self> {
        some_pb
...
impl TryFrom<MeasurementSystemProfilePb> for MeasurementSystemProfile {
    ...
    fn try_from(msg: MeasurementSystemProfilePb) -> crate::Result<Self> {
        let attrs: crate::Result<Vec<MeasurementSystemProfileAttrRecord>> = msg
            .attrs
            .iter()
            .map(
        ...
        Ok(Self {
            profile_id: MeasurementSystemProfileId::try_from(msg.profile_id)
                .map_err(|e| crate::Error::RpcConversion(e.to_string()))?,
            name: msg.name.clone(),
            attrs: attrs?,
