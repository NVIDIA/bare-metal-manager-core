    ...
    T: UuidSubtype,
{
    ...
    // Construct a TypedUuid<T> from an Option<rpc::Uuid>, which is a common
...
impl<T> TryFrom<&rpc::Uuid> for TypedUuid<T>
where
    T: UuidSubtype,
{
    type Error = UuidError;

    fn try_from(rpc_uuid: &rpc::Uuid) -> Result<Self, Self::Error> {
...
impl<T> From<TypedUuid<T>> for rpc::Uuid
where
    T: UuidSubtype,
{
