...
extern "C" {
    ...
    pub fn ipmi_ctx_open_outofband(ctx: ipmi_ctx_t,
    ...
    pub fn ipmi_ctx_open_outofband_2_0(ctx: ipmi_ctx_t,
                                       hostname: *const c_char,
                                       username: *const c_char,
                                       password: *const c_char,
                                       k_g: *const c_uchar,
    ...
    pub fn ipmi_ctx_open_inband(ctx: ipmi_ctx_t,
    ...
    pub fn ipmi_ctx_find_inband(ctx: ipmi_ctx_t,
                                driver_type: ipmi_driver_type_t,
                                disable_auto_probe: c_int,
                                driver_address: c_ushort,
                                register_spacing: c_uchar,
    ...
    pub fn ipmi_cmd_set_power_restore_policy(ctx: ipmi_ctx_t,
                                             power_restore_policy: c_uchar,
                                             obj_cmd_rs: fiid_obj_t) -> c_int;
    /// Inner libfreeipmi C unsafe API - set chassis power cycle interval
    pub fn ipmi_cmd_set_power_cycle_interval(ctx: ipmi_ctx_t,
                                             interval: c_uchar,
                                             obj_cmd_rs: fiid_obj_t) -> c_int;
    /// Inner libfreeipmi C unsafe API - get system restart cause recorded by BMC
    pub fn ipmi_cmd_get_system_restart_cause(ctx: ipmi_ctx_t,
                                             obj_cmd_rs: fiid_obj_t) -> c_int;
    /// Inner libfreeipmi C unsafe API - set system boot options
    pub fn ipmi_cmd_set_system_boot_options(ctx: ipmi_ctx_t,
    ...
    pub fn ipmi_cmd_get_system_boot_options(ctx: ipmi_ctx_t,
                                            parameter_selector: c_uchar,
                                            set_selector: c_uchar,
                                            block_selector: c_uchar,
                                            obj_cmd_rs: fiid_obj_t) -> c_int;
    /// Inner libfreeipmi C unsafe API - get system power on hours
    pub fn ipmi_cmd_get_power_on_hours_counter(ctx: ipmi_ctx_t,
                                               obj_cmd_rs: fiid_obj_t) -> c_int;
    ...
    /// Inner libfreeipmi C unsafe API - fiid api
    pub fn fill_cmd_chassis_identify(identify_interval: *const c_uchar,
                                     force_identify: *const c_uchar,
                                     obj_cmd_rq: fiid_obj_t) -> c_int;
    /// Inner libfreeipmi C unsafe API - fiid api
    pub fn fill_cmd_set_power_restore_policy(power_restore_policy: c_uchar,
                                             obj_cmd_rq: fiid_obj_t) -> c_int;
    /// Inner libfreeipmi C unsafe API - fiid api
    ...
    /// Inner libfreeipmi C unsafe API - fiid api
    pub fn fill_cmd_set_system_boot_options(parameter_selector: c_uchar,
                                            parameter_valid: c_uchar,
                                            configuration_parameter_data: *const c_void,
                                            configuration_parameter_data_len: c_uint,
                                            obj_cmd_rq: fiid_obj_t) -> c_int;
    /// Inner libfreeipmi C unsafe API - fiid api
    pub fn fill_cmd_get_system_boot_options(parameter_selector: c_uchar,
                                            set_selector: c_uchar,
                                            block_selector: c_uchar,
                                            obj_cmd_rq: fiid_obj_t) -> c_int;
...
pub mod ipmi {
    ...
    use crate::{auth_type, chassis_identify_state, cipher_suite, fiid_obj_create, fiid_obj_destroy, FIID_OBJ_GET, fiid_obj_t, ipmi_cmd_chassis_control, ipmi_cmd_get_chassis_status, ipmi_ctx_close, ipmi_ctx_create, ipmi_ctx_destroy, ipmi_ctx_open_inband, ipmi_ctx_open_outofband, ipmi_ctx_open_outofband_2_0, ipmi_ctx_t, ipmi_error, ipmi_interface, power_control, power_restore_policy_state, privilege_level};
    ...
    use crate::ipmi_interface::{IPMI_DEVICE_LAN, IPMI_DEVICE_LAN_2_0, IPMI_DEVICE_KCS};
    use crate::ipmi_errnum::{IPMI_ERR_CTX_INVALID, IPMI_ERR_DEVICE_NOT_SUPPORTED, IPMI_ERR_OUT_OF_MEMORY};
    ...
    use crate::{tmpl_cmd_get_chassis_status_rs, tmpl_cmd_chassis_control_rs};
    ...
    impl ipmi_ctx {
        ...
        pub fn new(host: String, user: String, pass: String,
                   intf: Option<ipmi_interface>, algo: Option<cipher_suite>,
                   mode: Option<privilege_level>, auth: Option<auth_type>) -> ipmi_ctx
        {
            ipmi_ctx {  hostname: host, username: user, password: pass,
        ...
        pub fn connect(&mut self) -> Result<(), ipmi_error> {
            ...
            if self.freeipmi_ctx.is_null() {
                return Err(ipmi_error::ipmi_error_ctx_invalid(IPMI_ERR_CTX_INVALID as i32));
            }

            match intf {
                IPMI_DEVICE_LAN=> unsafe {
                    ret = ipmi_ctx_open_outofband(self.freeipmi_ctx,
                                                  c_hostname.as_ptr(),
                                                  c_user.as_ptr(),
                                                  c_pass.as_ptr(),
                ...
                IPMI_DEVICE_LAN_2_0 => unsafe {
                    ret = ipmi_ctx_open_outofband_2_0(self.freeipmi_ctx,
                                                      c_hostname.as_ptr(),
                                                      c_user.as_ptr(),
                                                      c_pass.as_ptr(),
                                                      ptr::null(),
                ...
                IPMI_DEVICE_KCS => unsafe {
                    ret = ipmi_ctx_open_inband(self.freeipmi_ctx, IPMI_DEVICE_KCS,
                                               0, 0, 0, null_mut(), 0, 0);
                },
        ...
        pub fn chassis_status(&mut self) -> Result<Vec<chassis_status_item>, ipmi_error> {
            ...
            let mut queries: Vec<chassis_status_item> = vec![
                chassis_status_item { query: String::from("current_power_state.power_is_on"), value: false },
                chassis_status_item { query: String::from("current_power_state.power_overload"), value: false },
                chassis_status_item { query: String::from("current_power_state.interlock"), value: false },
                chassis_status_item { query: String::from("current_power_state.power_fault"), value: false },
                chassis_status_item { query: String::from("current_power_state.power_control_fault"), value: false },
                chassis_status_item { query: String::from("last_power_event.ac_failed"), value: false },
                chassis_status_item { query: String::from("last_power_event.power_down_caused_by_power_overload"), value: false },
                chassis_status_item { query: String::from("last_power_event.power_down_caused_by_power_interlock_being_activated"), value: false },
                chassis_status_item { query: String::from("last_power_event.power_down_caused_by_power_fault"), value: false },
                chassis_status_item { query: String::from("last_power_event.power_on_entered_via_ipmi"), value: false },
                chassis_status_item { query: String::from("misc_chassis_state.chassis_intrusion_active"), value: false },
                chassis_status_item { query: String::from("misc_chassis_state.front_panel_lockout_active"), value: false },
                chassis_status_item { query: String::from("misc_chassis_state.drive_fault"), value: false },
                chassis_status_item { query: String::from("misc_chassis_state.cooling_fan_fault_detected"), value: false },
                chassis_status_item { query: String::from("front_panel.power_off_button_disabled"), value: false },
                chassis_status_item { query: String::from("front_panel.reset_button_disabled"), value: false },
                chassis_status_item { query: String::from("front_panel.standby_button_disabled"), value: false },
                chassis_status_item { query: String::from("front_panel.diagnostic_interrupt_button_disabled"), value: false },
                chassis_status_item { query: String::from("front_panel.power_off_button_disable_allowed"), value: false },
                chassis_status_item { query: String::from("front_panel.reset_button_disable_allowed"), value: false },
                chassis_status_item { query: String::from("front_panel.standby_button_disable_allowed"), value: false },
                chassis_status_item { query: String::from("front_panel.diagnostic_interrupt_button_disable_allowed"), value: false },
            ];
            ...
            unsafe {
                ...
                for item in queries.iter_mut() {
                    ...
                    if ret < 0 {
                        fiid_obj_destroy(obj_cmd_rs);
                        return Err(ipmi_error::ipmi_error_fiid_query(String::from(item.query.as_str()), ret as i32));
                    }
                    if val > 0 {
                        item.value = true;
                    }
                ...
                if ret < 0 {
                    fiid_obj_destroy(obj_cmd_rs);
                    return Err(ipmi_error::ipmi_error_fiid_query(String::from(restore_status.query.as_str()), ret as i32));
                }
                ...
                if ret < 0 {
                    fiid_obj_destroy(obj_cmd_rs);
                    return Err(ipmi_error::ipmi_error_fiid_query(String::from(identify_status.query.as_str()), ret as i32));
                }
...
mod tests {
    ...
    #[test]
    fn it_works() {
        let mut ctx = ipmi_ctx::new(String::from("dummy_host"),
