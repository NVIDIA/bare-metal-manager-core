...
components_dir := "api pxe dns dhcp dev/bmc-mock dev/machine-a-tron admin"
components_name := "\"carbide-api --features carbide-api/tss-esapi\" carbide-pxe carbide-dns dhcp bmc-mock machine-a-tron admin"
